...
function form_actions() {
	...
	$selected_items_html = (isset($profile_array) ? selected_items_payload($profile_array) : '');
...
function profile() {
	...
	$sql_order = get_order_string(array('name', 'step', 'heartbeat', 'data_sources', 'templates'));
