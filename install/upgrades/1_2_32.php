...
function upgrade_to_1_2_32() {
	...
	/* The ALTER above settles the question poller_refresh_output_table asked.
	 * Nothing has read the setting for some time, so drop the stored row with
	 * the checkbox rather than leave an answer to a question nobody asks. */
	...
	/* allow_unsafe_https now defaults to off for new installs. An install
