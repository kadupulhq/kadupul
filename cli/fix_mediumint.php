...
function display_version()
{
    ...
    print "Kadupul Fix Database Range Issue, Version $version, " . COPYRIGHT_YEARS . "\n";
}
...
function display_help()
{
    ...
    print 'This utility is used to increase the size of key Kadupul columns to accomodate' . PHP_EOL;
    print 'systems with over a million graphs and that have been in service for years.' . PHP_EOL;
    print 'After some long amount of time, Kadupul can run out of auto_increment fields.' . PHP_EOL;
}
