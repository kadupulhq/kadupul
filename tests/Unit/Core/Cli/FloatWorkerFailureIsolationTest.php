...
function rrd_maintenance_acquire($exclusive,$blocking,$timeout){$GLOBALS['attempts']++;if(!$exclusive || !$blocking || $timeout!==5){throw new RuntimeException('Unbounded or incorrect storage lease');}return !$GLOBALS['busy'];}
