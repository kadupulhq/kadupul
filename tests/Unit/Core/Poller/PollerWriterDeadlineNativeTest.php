...
function process_poller_output(&$pipe, $remainder = 0, &$deferred = null) {
    $deferred = rrdtool_execute('update ' . __DIR__ . '/sample.rrd 1700000000:1', false, RRDTOOL_OUTPUT_BOOLEAN, $pipe) !== true;
    return $deferred ? 0 : 1;
}
...
$result = process_poller_output_batch(true, $deferred, $proxy, microtime(true) + 2);
