...
test('graph.php redirects invalid graph requests to the fixed graph view through cacti_header', function () use ($graphPath) {
    expect(file_get_contents($graphPath))->toContain("cacti_header('graph_view.php')");
});
