 ...
 * database connection or full Kadupul bootstrap.
 */
...
// Exact-value regression: representative Kadupul call with a mid-range color
...
test('colourBrightness produces correct exact value for representative Kadupul call (lighter)', function () {
	// '1a2b3c': r=26,g=43,b=60 → lighter by 0.4 → r=163(a3),g=170(aa),b=177(b1)
	expect(colourBrightness('1a2b3c', 0.4))->toBe('a3aab1');
});

test('colourBrightness produces correct exact value for representative Kadupul call (darker)', function () {
