...
foreach (array('rrdtool_pipe_encoder', 'rrdtool_pipe_quote', 'rrdtool_proxy_token_is_safe', 'rrdtool_proxy_token', 'rrdtool_command_argument', 'rrdtool_command_path') as $function) {
