...
final class DeviceRemovalDependentsTest extends TestCase
{
    ...
    public function testFinalChecksDoNotDependOnDeletedParents(?string $insertion): void
    {
        ...
        $sqlite->exec('CREATE TABLE data_template_data (id INTEGER, local_data_id INTEGER); CREATE TABLE data_template_rrd (id INTEGER, local_data_id INTEGER); CREATE TABLE graph_templates_item (id INTEGER, local_graph_id INTEGER, task_item_id INTEGER); CREATE TABLE data_input_data (data_template_data_id INTEGER)');
    ...
    public static function orphans(): iterable
    {
        ...
        yield 'input points to deleted template' => ['INSERT INTO data_input_data VALUES (101)'];
