...
final class LegacyDevicesTest extends TestCase
{
    public function testCompatibilityLinksNeverReplayMutations(): void
    {
        ...
        try {
            ...
            foreach (['?action=edit' => '/inventory/devices/new','?action=edit&id=7' => '/inventory/devices/7/edit','?action=gt_remove&host_id=7&id=2' => '/inventory/devices/7/associations/graph','?action=query_add&host_id=7' => '/inventory/devices/7/associations/query','?action=repopulate&host_id=7' => '/inventory/devices/7/maintenance','?action=ping_host&id=7' => '/inventory/devices/7/maintenance'] as $query => $target) {
