...
foreach ([2 => 'files', 3 => 'database', 4 => 'none'] as $argument => $handler) {
    ...
    foreach ($reports as $report) {
        ...
        foreach ($data['files'] as $path => $file) {
            ...
            if (!str_starts_with($relative, 'src/') && !in_array($relative, ['bin/legacy-device-edit.php', 'bin/legacy-device-create.php', 'bin/legacy-device-template.php', 'bin/legacy-device-collector.php', 'bin/legacy-device-associations.php', 'bin/legacy-assignment-bootstrap.php', 'bin/legacy-device-placement.php', 'bin/legacy-device-maintenance.php', 'bin/legacy-device-state.php', 'bin/legacy-device-remove.php', 'app.php', 'sites.php', 'lib/database.php', 'public/index.php', 'config/bootstrap.php', 'tools/verify-offline.php', 'tools/dependencies/install-legacy.php'], true)) {
                continue;
            }
            $local = $root . '/' . $relative;
