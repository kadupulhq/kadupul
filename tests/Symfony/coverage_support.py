...
def publish_coverage(output, database_sessions, checks):
    ...
    sources = ['session_bridge.py', 'inventory_scenarios.py', 'details_scenarios.py', 'site_scenarios.py', 'site_catalog_scenarios.py', 'site_edit_scenarios.py', 'site_create_scenarios.py', 'site_creation_probe.php', 'site_authorization_probe.php', 'device_edit_scenarios.py', 'coverage_support.py']
