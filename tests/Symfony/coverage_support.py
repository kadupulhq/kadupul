...
def publish_coverage(output, database_sessions, checks):
    ...
    source_paths = [f'tests/Symfony/{name}' for name in sources] + ['tests/Fixtures/plugins/compatibility_test/setup.php', 'tests/Fixtures/legacy-cli/analyze_database.php']
