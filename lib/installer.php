	...
	public function processStepMode() {
		...
		switch ($this->mode) {
			case Installer::MODE_UPGRADE:
				...
				$output .= Installer::sectionWarning(__('In the event of issues, It is highly recommended that you clear your browser cache, closing then reopening your browser (not just the tab Kadupul is on) and retrying, before raising an issue with The Kadupul Group'));
