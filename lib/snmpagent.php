 ...
 * Generates a SNMP caching tables reflecting all objects of the Kadupul MIB
 * @return
 */
...
function snmpagent_notification($notification, $mib, $varbinds, $severity = SNMPAGENT_EVENT_SEVERITY_MEDIUM, $overwrite = false)
{
    ...
    $enterprise_oid = db_fetch_cell_prepared(
        'SELECT oid
    ...
    $notification_managers = db_fetch_assoc_prepared(
        'SELECT snmpagent_managers.*
    ...
    $reg_var_binds = db_fetch_assoc_prepared(
        'SELECT
