...
function form_save()
{
    if (isset_request_var('save_component_template')) {
        ...
        $save3['rrd_maximum']           = form_input_validate(get_nfilter_request_var('rrd_maximum'), 'rrd_maximum', data_source_limit_pattern(array('ifSpeed')), (isset_request_var('t_rrd_maximum') ? true : false), 3);
        ...
        $save3['rrd_minimum']           = form_input_validate(get_nfilter_request_var('rrd_minimum'), 'rrd_minimum', data_source_limit_pattern(), (isset_request_var('t_rrd_minimum') ? true : false), 3);
