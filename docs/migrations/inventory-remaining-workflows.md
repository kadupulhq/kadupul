...
| Device bulk options, statistics and template synchronization | Statistics reset implemented in PR #288; template synchronization implemented in PR #295; bulk location/polling options implemented in PR #299; bulk assignments in implementation; SNMP credentials pending |
