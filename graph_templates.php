...
function form_actions() {
	...
	$selected_items_html = (isset($graph_array) ? selected_items_payload($graph_array) : '');
		...
		<form id='form_graph_template' action='graph_templates.php'>
			<table class='filterTable' role='presentation'>
				<tr>
					...
					<td>
						<input type='text' class='ui-state-default' id='filter' name='filter' size='25' value='<?php
