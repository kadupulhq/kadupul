...
function automation_graph_rules_form_actions() {
	...
	$selected_items_html = (isset($automation_graph_rules_array) ? selected_items_payload($automation_graph_rules_array) : '');
...
<table role='presentation' style='width:100%;text-align:center;'>
	<tr>
		<?php
			...
			print $automation_output_0 . ($_SESSION['automation_graph_rules_show_rule'] == true ? '0' : '1');
			print '\'>';
			print ($_SESSION['automation_graph_rules_show_rule'] == true ? __('Don\'t Show'):__('Show'));
			print ' ';
			print __('Rule Details.');
			print '</a><br>';
		?>
		</td>
	</tr>
