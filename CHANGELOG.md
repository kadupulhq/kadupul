...
- Refresh bundled DOMPurify, D3, jQuery UI, tablesorter and HTML Purifier, pin Composer resolution to the existing PHP runtime floors, and verify browser-library provenance and compatibility in CI.
