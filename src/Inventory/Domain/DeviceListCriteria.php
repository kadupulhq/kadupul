...
final readonly class DeviceListCriteria
{
    ...
    public function __construct(string $search = '', public string $state = 'all', public int $page = 1, public int $pageSize = 25, public string $status = 'all', public DeviceOrder $order = new DeviceOrder(), public ?int $siteId = null)
    {
