...
final readonly class ListDeviceSites
{
    public function __construct(private ConsoleAccess $access, private DeviceSites $sites) {}
    ...
    public function __invoke(): array
    {
        ...
        return $this->sites->visibleTo($actor->id);
    }
}
