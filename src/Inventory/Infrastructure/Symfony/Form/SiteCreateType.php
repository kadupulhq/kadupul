...
final class SiteCreateType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder->add('timezone', ChoiceType::class, ['label' => 'Timezone', 'required' => false, 'placeholder' => 'Default timezone', 'choices' => array_combine($zones, $zones), 'choice_translation_domain' => false, 'empty_data' => '']);
